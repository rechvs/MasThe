...
*** CURRENT What is a “smooth function”?
*** CURRENT What is a “regression spline”?
** CURRENT Add clean up sections to each block in [[file:R/Scripts/DataSetCreation.R::##%20Preamble][DataSetCreation.R]] (to prevent obstruction of the workspace by objects no longer needed if the script is called from outside)
