...
*** CURRENT Read Pretzsch (2000)
    + [2017-06-28 Mi]: continue with section 3., p. 207 f.
*** CURRENT Acquire Daniel & Sterba (1980)
    + complete reference:
      Daniel, T. W. & Sterba, H. (1980): “Zur Ansprache der Bestandesdichte”, Allgemeine Forstzeitung 91, 155-157
    + SIG: II, 255
    + article supposedly (cp. Röhrig (1992), p.30) deals with converting Reineke’s SDI from imperial to metric system
    + [2017-06-28 Mi]: needs to be ordered at BBF desk
...
**** How to tag a comment (i.e., an individual “entry” within the “Abstract” portion of a JabRef entry)
     “- p. XY: {TAG1; TAG2}
      This is where the actual comment content goes.”
**** How to tag a whole entry
     “- whole TYPE_OF_MEDIUM: {TAG1; TAG2}”
     + Subsequent comments should only be tagged if their tag set differs from that of the whole entry.
