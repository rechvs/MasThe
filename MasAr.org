...
** Explanation of [[file:R/Scripts/MasArThesisRCode.org::1][MasArThesisRCode.org]]
   + The file should contain all R code used for producing the figures and numbers included in the Thesis.
   + Each topic should be given its own block, even if this means a single block creates multiple figures (e.g., one per species).
   + Each block should contain the name of the TEX file which incorporates the figure produced in the block.
** Diary
*** [2017-05-26 Fr]
...
** .tex files
   + Files, macros, and labels should be named like this: “FileName.tex”, “MacroName”, and “LabelName”
