...
\begin{singlespace}
  {\tabulinesep=2mm
    \begin{longtabu}{L S S S S}
      \caption{Absolute productivity index of stand (\(\ProductivityIndexMath{}\)) of different yield classes for \Beech{} and \Spruce{} as reported in \parencite{Schober1995} (moderate thinning).  \label{tab:SchoberProductivityIndices}} \\
      \toprule
      & \multicolumn{4}{c}{{\(\ProductivityIndexMath{}\) [\si{\meter}]}} \\
      \cline{2-5}
      Species & {yield class 4} & {yield class 3} & {yield class 2} & {yield class 1} \\
      \midrule
      \endhead
      \bottomrule
      \endlastfoot
      Beech & 20.7 & 24.7 & 28.6 & 32.4 \\
      Spruce & 23.5 & 27.2 & 31.2 & 35.1 \\
    \end{longtabu}
  }
\end{singlespace}
