...
The approach for selecting maximum basal area observations employed in this study uses \refeq{eq:reineke} in combination with species-specific thresholds of the self-thinning rate.  It examines observations belonging to a stand in chronological order, while attempting to answer 3 questions:
\begin{enumerate}
...
% Figures \ref{fig:beech_logN_logD_Plot_before_after_data_selection} and \ref{fig:spruce_logN_logD_Plot_before_after_data_selection} provide a comparison of the data set before and after application of the data selection mechanism.
