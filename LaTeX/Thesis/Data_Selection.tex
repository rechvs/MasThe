...
\begin{landscape}
  \begin{figure}[h]
    \caption{Flowchart representing the mechanism used for selecting observations considered as maximum stand density observations.}  %% CONTINUE HERE or add the symbols used in this figure to the table in "Abbrevs_Symbols.tex".
  {
    \footnotesize
    % \small
