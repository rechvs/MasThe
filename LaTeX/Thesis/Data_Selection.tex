...
In all plots of \reffig{fig:logN_logD_Plots_before_after_data_selection}, the dashed and solid black lines exemplify the species-specific upper and lower slope thresholds, respectively.
Thus, an observation from a plot in column A (before application of the data selection mechanims) is present in the corresponding plot of column B (after application of the data selection mechanism) if
\begin{itemize}
