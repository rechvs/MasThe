...
\end{equation}
GCV replaces \(S_{ii}(\uplambda)\) in \RefEq{eq:CrossValidationSumOfSquares02} with its mean value \(\text{tr}\bigl(\symbf{S}_\uplambda\bigr) \big/ n\), since it is easier to compute:
\begin{equation}
