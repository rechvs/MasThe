...
\begin{equation}
  ...
  \end{cases}
\end{equation}
\parencite{Bollaerts2006}, where \(\kappa\) is a user-defined constraint parameter for fine-tuning the constraint strength and where all other symbols retain the same meaning as in \RefEq{eq:PSplineOLS}.
