  ...
  \begin{center}
    ...
    \begin{minipage}{0.73\textwidth}  %% DO NOT change the minipage width, since it was manually set to ensure correct horizontal alignment of the previous and this minipage. 
      ...
      \begin{block}{Quellen}
        \begin{tiny}
          \begin{enumerate}
          \item \emph{Döbbeler H., Spellmann H.} (2002): Methodological Approach to Simulate and Evaluate Silvicultural Treatments under Climate Change. \emph{Forstwissenschaftliches Centralblatt}, 121 Supplement 1: 52--69  %% uncomment this entry (and refer to it) AFTER checking it for its relevance
