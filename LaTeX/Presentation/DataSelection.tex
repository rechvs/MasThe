  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \visible<\theFirstElement->{
        ...
        \end{tikzpicture}
        \captionsep{}
        \mycaption{Abbildung}{Schematische Darstellung des beobachteten Zusammenhangs zwischen Bestandesdichte \(N\) und mittlerem Durchmesser \(D\).}
      }
    \end{column}
    \begin{column}{0.5\textwidth}
  ...
  \visible<1->{
    \centerline{
      \begin{minipage}{0.9\textwidth}
        ...
        \captionsep{}
        \mycaption{Abbildung}{Beobachteter Zusammenhang zwischen Bestandesdichte \(N\) und mittlerem Durchmesser \(D\).  Farbige Linien verbinden Beobachtungen eines Bestandes. Gestrichelte bzw. durchgezogene schwarze Linien stellen den oberen bzw. unteren Schwellwert der noch ,,erlaubten`` Mortalitätsraten beispielhaft dar. \\
