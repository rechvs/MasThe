    ...
    \begin{center}
      \begin{minipage}{0.40\textwidth}
        ...
        \mycaption{Gleichung 1}{Bestandesdichte in Abhängigkeit von mittlerem Durchmesser (Quelle: [1]). \\
          ...
          \(s\): Steigung (\(\hat{=}\) \textcolor{red}{Mortalitätsrate}) \\
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \visible<\theFirstElement->{
        ...
        \end{tikzpicture}
        \captionsep{}
        \mycaption{Abbildung 1}{Schematische Darstellung des beobachteten Zusammenhangs zwischen Bestandesdichte \(N\) und mittlerem Durchmesser \(D\).}
      }
    \end{column}
    \begin{column}{0.5\textwidth}
  ...
  \visible<1->{
    \centerline{
      \begin{minipage}{0.9\textwidth}
        ...
        \captionsep{}
        \mycaption{Abbildung 2}{Beobachteter Zusammenhang zwischen Bestandesdichte \(N\) und mittlerem Durchmesser \(D\).  Farbige Linien verbinden Beobachtungen eines Bestandes. Gestrichelte bzw. durchgezogene schwarze Linien stellen den oberen bzw. unteren Schwellwert der noch ,,erlaubten`` Mortalitätsraten beispielhaft dar. \\
