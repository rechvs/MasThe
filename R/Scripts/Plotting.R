...
kSubsettingInformation <- list(
    ...
    "ksha.clean.mean.edvid.ratio_geq_0.75/" = list("subsetting.vector" = bart.clean[["ksha.clean.mean.edvid.ratio"]] >= 0.75,
                                                   "kPlotMainAppendix" = ", subset: ksha.clean.mean.edvid.ratio >= 0.75."),
...
for (cur.subsetting.info.name in names(x = kSubsettingInformation)) {
    ...
    kPlottingInformation <- list(
        "meas_h100_gha" = list("kXSource" = "data.src$h100",
        ...
        "meas_alt_ekl" = list("kXSource" = "data.src$alt",
                              "kYSource" = "data.src$ekl",
                              "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                              "kPlotXLab" = "alt [a]",
                              "kPlotYLab" = "ekl"),
        "meas_alt_gha" = list("kXSource" = "data.src$alt",
                              "kYSource" = "data.src$gha",
                              "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                              "kPlotXLab" = "alt [a]",
                              "kPlotYLab" = expression("gha [m"^2*" ha"^-1*"]")),
        "meas_alt_SI.h100" = list("kXSource" = "data.src$alt",
                                  "kYSource" = "data.src$SI.h100",
                                  "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                                  "kPlotXLab" = "alt [a]",
                                  "kPlotYLab" = "SI.h100 [m]"),
        "meas_ln.dg_ln.nha" = list("kXSource" = "data.src$ln.dg",
                                   "kYSource" = "data.src$ln.nha",
                                   "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                                   "kPlotXLab" = "ln.dg",
                                   "kPlotYLab" = "ln.nha"),
        "meas_log.dg_log.nha" = list("kXSource" = "data.src$log.dg",
                                     "kYSource" = "data.src$log.nha",
                                     "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                                     "kPlotXLab" = "log.dg",
                                     "kPlotYLab" = "log.nha"),
        "meas_alt_ksha" = list("kXSource" = "data.src$alt",
                               "kYSource" = "data.src$ksha",
                               "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                               "kPlotXLab" = "alt [a]",
                               "kPlotYLab" = expression("ksha [m"^2*" ha"^-1*"]")),
        "meas_h100_ksha" = list("kXSource" = "data.src$h100",
                                "kYSource" = "data.src$ksha",
                                "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                                "kPlotXLab" = "h100 [m]",
                                "kPlotYLab" = expression("ksha [m"^2*" ha"^-1*"]")),
        "meas_h100_h100.diff.EKL.I" = list("kXSource" = "data.src$h100",
                                           "kYSource" = "data.src$h100.diff.EKL.I",
                                           "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                                           "kPlotXLab" = "h100 [m]",
                                           "kPlotYLab" = "h100.diff.EKL.I [m]"),
        "meas_gha_ksha" = list("kXSource" = "data.src$gha",
                               "kYSource" = "data.src$ksha",
                               "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                               "kPlotXLab" = expression("gha [m"^2*" ha"^-1*"]"),
                               "kPlotYLab" = expression("ksha [m"^2*" ha"^-1*"]")),
        "meas_gha_ksha.clean" = list("kXSource" = "data.src$gha",
                                     "kYSource" = "data.src$ksha.clean",
                                     "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                                     "kPlotXLab" = expression("gha [m"^2*" ha"^-1*"]"),
                                     "kPlotYLab" = expression("ksha.clean [m"^2*" ha"^-1*"]")),
        "meas_ghaa.cum_gha" = list("kXSource" = "data.src$ghaa.cum",
                                   "kYSource" = "data.src$gha",
                                   ...
                                   "kPlotYLab" = expression("gha [m"^2*" ha"^-1*"]")),
        "meas_ksha.clean_gha" = list("kXSource" = "data.src$ksha.clean",
                                     "kYSource" = "data.src$gha",
                                     ...
                                     "kPlotYLab" = expression("gha [m"^2*" ha"^-1*"]")),
        "meas_alt_ksha.clean" = list("kXSource" = "data.src$alt",
                                     "kYSource" = "data.src$ksha.clean",
                                     "kPlotMain" = paste0("data = data.src (art == 511, ksha.rel >= 0.7, gha.rel.cha >= -0.05)", kSubsettingInformation[[cur.subsetting.info.name]][["kPlotMainAppendix"]]),
                                     "kPlotXLab" = "alt [a]",
                                     "kPlotYLab" = expression("ksha.clean [m"^2*" ha"^-1*"]")))
