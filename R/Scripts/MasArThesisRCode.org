...
* TopHeightBasalAreaObservationsGAMLSS3SCAM1SterbaPredictionsYieldClassClassification.pdf
  ...
  #+BEGIN_SRC R :results silent :var input=Preamble :session *MasArThesisRConsole*
    ...
    kSterbaCoefs <- list("Wördehoff" = list("beech" = list("a0" = 2.616551e-07,  ## Source: Wördehoff (2016), tab. 3.6
					         "a1" = 1.368151,
					         "b0" = 6.496417,
					         "b1" = -1.731867),
				    "spruce" = list("a0" = 4.913256e-06,
						...
						"b0" = 0.3716977,
						"b1" = -0.9097641)),
		     "Döbbeler" = list("beech" = list("a0" = 1.0829E-07,  ## Source: Döbbeler (2004), tab. 4.2, Region Nordwest
					        "a1" = 1.5374,
					        "b0" = 8.3652,
					        "b1" = -1.7365),
